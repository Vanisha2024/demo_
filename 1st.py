...
def call_gemini(prompt):
    ...
    # Read as: "headers is a dictionary that specifies 
    # the content type as JSON."

    # API key is passed as a parameter in the request.
    params = {"key": API_KEY}  
    # Read as: "params is a dictionary containing the API key, 
    # needed for authentication."

    # Creating the payload (data to send in the request).
    payload = {
        "contents": [{  
            "parts": [{"text": prompt}]
        }]
